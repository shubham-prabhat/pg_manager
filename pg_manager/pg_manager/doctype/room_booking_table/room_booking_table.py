...
def get_room_details(room):
    room_details = frappe.get_value('Room', room, ['room_type', 'custom_room_number', 'floor_no', 'room_pricing', 'room_status'], as_dict=True)
    return room_details
...
def get_room_booking_details(room_booking_name):
    room_booking_details = frappe.get_value('Room Booking Table',
                                            ...
                                            ['room_type', 'room_no',  'floor_no', 'room_status'],
                                            as_dict=True)
